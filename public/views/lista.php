...
<body>
    <div class="container3">
        ...
        <div>
            <img id="i_1" src="public/img/uncheck.svg">
        </div>
        <div class="slope_list"></div>
        <main>
            <div>
                <img id="check_background" src="public/img/check_background.svg">
            </div>
            <div>
                <img id="nazwa_stoku" src="public/img/nazwa_stoku.svg">
            </div>
            <div>
                <button>X</button>
            </div>
